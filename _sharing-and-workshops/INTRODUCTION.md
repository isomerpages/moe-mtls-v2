...
<a href="/iw-chinese-session"><div style="display:inline-block;font-size:25px;" class="btnClass1">Interactive Workshops</div></a>
	<br>
	<a target="_blank" href="https://www.event-reg.biz/Registration/eventreg?event=MTLSReg"><div style="display:inline-block;font-size:25px;" class="btnClass2">REGISTER<br>NOW</div></a>
	</div></div>